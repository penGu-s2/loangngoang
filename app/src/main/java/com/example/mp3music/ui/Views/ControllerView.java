package com.example.mp3music.ui.Views;
...
import com.example.mp3music.MediaController;
import com.example.mp3music.databinding.UiControlBinding;
...
public class ControllerView extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public void setService(@NotNull MP3Service service) {
